...
# PRODUCT_COPY_FILES := device/xiaomi/helium/configs/apns-full-conf.xml:system/etc/apns-conf.xml
...
$(call inherit-product-if-exists, vendor/xiaomi/helium/device-vendor.mk)
